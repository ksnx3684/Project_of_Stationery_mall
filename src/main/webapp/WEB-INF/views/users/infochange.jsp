...
<body>
    ...
    <form class="frm" action="./infochange" method="post" id="frm" enctype="multipart/form-data">
        <fieldset>
            <legend>ID</legend>
            <input type="text" placeholder="ID" name="id" id="id" value="${usersDTO.id}" readonly>
        </fieldset>
        <fieldset>
            <legend>이름</legend>
            <input type="text" name="name" id="name" value="${usersDTO.id}" readonly>
        </fieldset>
        <fieldset>
            <legend>전화번호</legend>
            <input type="text" placeholder="전화번호" name="phone" id="phone" value="${usersDTO.phone}">
        </fieldset>
        <fieldset>
            <legend>이메일</legend>
